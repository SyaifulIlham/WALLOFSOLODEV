        ...
        <div className="sidebar-admin d-none d-lg-flex flex-column" style={{ width: '260px', backgroundColor: '#131722', borderRight: '1px solid #1f2636', padding: '30px 20px' }}>
            ...
            <ul className="nav flex-column gap-2 mb-auto">
                ...
                <li className="nav-item">
                    <Link to="/admin" className={`nav-link rounded-3 px-3 py-2 d-flex align-items-center gap-3 ${activeMenu === 'catalog' || activeMenu === 'add' ? 'admin-menu-active' : 'admin-menu'}`}>
                        <span style={{ fontSize: '1.2rem' }}>•</span> Catalog Film
                    </Link>
                </li>
                <li className="nav-item">
                    <span className="nav-link admin-menu rounded-3 px-3 py-2 d-flex align-items-center gap-3" style={{ opacity: 0.5, cursor: 'not-allowed' }}>
