...
const DetailFilm = () => {
  ...
  return (
    <div style={{ backgroundColor: '#0a0b0d', minHeight: '100vh', color: '#fff' }}>
      ...
      {/* --- INI SOLUSINYA: Spasi kosong 100px biar rute gak ngumpet di balik Navbar --- */}
      <div style={{ height: '100px' }}></div>

      {/* Breadcrumb / Rute di pojok kiri atas */}
      <div className="container text-start" style={{ padding: '0 15px' }}>
        <p style={{ color: '#aaa', fontSize: '0.9rem' }}>
          <Link to="/" className="text-decoration-none hover-white" style={{ color: '#aaa', transition: 'color 0.3s ease' }}>
            Beranda
          </Link>
          <span className="mx-2">/</span>
          <Link to="/movies" className="text-decoration-none hover-white" style={{ color: '#aaa', transition: 'color 0.3s ease' }}>
            Film
          </Link>
          <span className="mx-2">/</span>
          <span style={{ color: '#fff', fontWeight: 'bold' }}>
            {film ? film.judul_film : '...'}
          </span>
        </p>
      </div>
          ...
          <div className="col-12">
            ...
            <div className="border-bottom border-secondary mb-4 pb-2 d-flex gap-4">
              <button
                ...
                style={{
                  color: activeTab === 'jadwal' ? '#fff' : '#6c757d',
                  borderBottom: activeTab === 'jadwal' ? '3px solid #0dcaf0' : '3px solid transparent',
                  cursor: 'pointer',
              ...
              <button
                ...
                className="bg-transparent border-0 p-0 pb-2 fw-bold fs-5"
                style={{
                  color: activeTab === 'detail' ? '#fff' : '#6c757d',
                  borderBottom: activeTab === 'detail' ? '3px solid #0dcaf0' : '3px solid transparent',
                  cursor: 'pointer',
                  transition: 'all 0.3s ease'
                }}
              >
      ...
      {/* CSS untuk efek hover tulisan Beranda & Film */}
      <style>
        {`
          .hover-white:hover {
